...
?>
  ...
  Toggle modal
    ...
    <!-- Main modal -->
    <div id="masterListRecord-modal" tabindex="-1" aria-hidden="true"
      ...
      <div id='modal-container' class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <button id='masterListRecCloseModal' type="button"
            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
            data-modal-hide="masterListRecord-modal">
          ...
          <div class="px-6 py-6 lg:px-8 no-print">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"><span id='masterListRecTitle'>Registration form</span>
              </h3>
