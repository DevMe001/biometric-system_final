...
<div class='flex gap-2 items-center mb-5 p-5'>
  ...
  <p class='text-indigo-500 '>Classes</p>
</div>
      ...
      <div class="relative w-full max-w-lg max-h-full" data-modal-backdrop="static">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"><span id='studentTitle'>Create</span> new
              class</h3>
            <form id='classesForm' class="space-y-6">
              ...
              <fieldset class='fieldset-class'>
                ...
                <div class="relative z-0 w-full mt-4 group">
                  <label for="className" class="mb-1 ">Room #</label>
                ...
                <div class='mb-4'>
                  ...
                  <label for="teacherClassItem"
                    class="w-full block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teacher name</label>
                  <select style="width: 100%;" id="teacherClassItem" name='teacherClassItem'
                    class="selectItem2Lib py-2 px-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
                ...
                <div class='mb-4'>
                  ...
                  <label for="classSectionName"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Class section</label>
                  <select style="width:100%;" id="classSectionName" name='classSectionName'
                ...
                <div class="flex justify-between items-center mt-5 ">
                  ...
                  <button id='classNextBtn__1'
                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
              ...
              <fieldset class='fieldset-class'>
                ...
                <div class='mb-4'>
                  ...
                  <label for="classYearLevel" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grade
                    level</label>
                  <select style="width:100%;" id="classYearLevel" name='classYearLevel'
                    class="selectItem2Lib px-5 py-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
                ...
                <div class="flex justify-between items-center mt-5 ">
                  <button id='classPrevBtn__2' type="button"
                    class="w-[10rem] text-white bg-cyan-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Previous</button>
                  <button id='classNextBtn__2'
                    class="w-[10rem] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
                </div>
              ...
              <fielset class="fieldset-class">
                ...
                <div class='mb-4'>
                  ...
                  <label for="timeofDay" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Time of
                    Day</label>
                ...
                <div class="flex gap-2 justify-between">
                  <div class="relative z-0 w-full mt-4 group">
                    <label for="className" class="mb-1 ">Start class</label>
                  ...
                  <div class="relative z-0 w-full mt-4 group">
                    <label for="className" class="mb-1 ">End class</label>
                ...
                <div class="flex justify-between items-center mt-5 ">
                  <button id='classPrevBtn__3' type="button"
                    class="w-[10rem] text-white bg-cyan-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Previous</button>
                  <button id='classNextBtn__3'
                    class="w-[10rem] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </div>
